...
public partial class ClientesAlbaranes : System.Web.UI.Page 
{
    ...
    {
        IList<Albaran> albaranes = CntAriGes.GetAlbarans(cliente.CodClien);
        BodyPedidos.InnerHtml = CntAriGes.GetAlbaransHtml(albaranes);
    }
}
