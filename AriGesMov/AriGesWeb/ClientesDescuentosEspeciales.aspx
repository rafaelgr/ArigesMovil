<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ClientesDescuentosEspeciales.aspx.cs" Inherits="ClientesDescuentosEspeciales" %>
    ...
    <body>
        <form id="form1" runat="server">
            ...
            <div class="container">
                ...
                <br />
                <div id="BodyDescuentosEspeciales" runat="server">
        ...
        <script type="text/javascript">
            (function ($) {
                $(document).ready(function () {
                    $('#DescuentosEspeciales').addClass('active');
                });
            })(jQuery);
        </script>
    </body>
